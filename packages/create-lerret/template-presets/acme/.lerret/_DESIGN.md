---
name: Acme
description: A product brand: confident, plain-spoken, never shouty.
colors:
  accent: "#B85B33"
  on-accent: "#FFFFFF"
  ink: "#1A1714"
...
A product surface: confident, plain-spoken, never shouty.

## Colors

`{colors.accent}` carries the piece — let it breathe rather than crowding it
...
- Don't put `{colors.accent}` next to another saturated color.
