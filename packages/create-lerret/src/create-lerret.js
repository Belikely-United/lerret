...
function printUsage() {
  process.stdout.write(
    [
      ...
      '  create-lerret <name> --preset=<preset>     Scaffold a named starter preset',
      '  create-lerret <name> --demo                Scaffold the guided demo walkthrough',
      ...
      '  --preset=...     Scaffold a named starter preset instead of the default one',
      '                   (valid: acme, appstore, producthunt, social-media, talks,',
      '                   personal, live)',
      '                   Mutually exclusive with --no-samples and --demo.',
      '  --demo           Scaffold the default teaching preset and mark the project so',
      '                   the studio offers its first-run walkthrough',
      '                   Mutually exclusive with --preset and --no-samples.',
      ...
      '  create-lerret my-project --preset=talks',
      '  create-lerret my-project --demo',
