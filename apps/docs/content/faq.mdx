...
**Because everything is React, every LLM already knows how to edit it.** Just files an AI was trained on millions of times over. Lerret's own AI comes two ways: the in-studio dock (bring your own key) and `/lerret`, installed as a Claude Code plugin (keyless, Claude Code only).
