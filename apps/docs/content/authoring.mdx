...
- On `@lerret/cli export`, custom fonts are **fully embedded** into each PNG/JPG capture so the output matches the studio's render.
...
- **[Examples](/examples/)** — sixteen complete, runnable assets covering OG cards, YouTube thumbnails, variants, computed `.data.js`, custom fonts, component showcases.
